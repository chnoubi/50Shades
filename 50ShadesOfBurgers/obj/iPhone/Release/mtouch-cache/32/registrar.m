...
void xamarin_create_classes () {
	...
	__xamarin_class_map [8].handle = objc_getClass ("UIFont");
	...
	__xamarin_class_map [22].handle = objc_getClass ("Foundation_InternalNSNotificationHandler");
	...
	__xamarin_class_map [36].handle = objc_getClass ("UINavigationItem");
	...
	__xamarin_class_map [43].handle = objc_getClass ("UIBarItem");
	__xamarin_class_map [44].handle = objc_getClass ("UIBezierPath");
	__xamarin_class_map [45].handle = objc_getClass ("UIControl");
	...
	__xamarin_class_map [50].handle = objc_getClass ("UIDevice");
	...
	__xamarin_class_map [64].handle = objc_getClass ("MKMapView");
	__xamarin_class_map [65].handle = objc_getClass ("NSTextAttachment");
