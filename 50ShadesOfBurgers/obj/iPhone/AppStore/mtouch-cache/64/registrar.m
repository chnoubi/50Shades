...
void xamarin_create_classes () {
	...
	__xamarin_class_map [39].handle = objc_getClass ("UIToolbar");
	__xamarin_class_map [40].handle = objc_getClass ("UIFont");
	__xamarin_class_map [41].handle = objc_getClass ("UIImage");
	__xamarin_class_map [42].handle = objc_getClass ("UINavigationBar");
	...
	__xamarin_class_map [86].handle = objc_getClass ("UITextView");
	...
	__xamarin_class_map [118].handle = objc_getClass ("UIKit_UITextField__UITextFieldDelegate");
