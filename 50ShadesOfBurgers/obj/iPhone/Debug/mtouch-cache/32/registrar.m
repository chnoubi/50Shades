...
static UITextField * native_to_managed_trampoline_22 (id self, SEL _cmd, MonoMethod **managed_method_ptr, const char *r0, const char *r1)
{
	MonoObject *retval = NULL;
	guint32 exception_gchandle = 0;
	UITextField * res = {0};
...
static void native_to_managed_trampoline_23 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UITextField * p0, const char *r0, const char *r1, const char *r2)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
static UIDatePicker * native_to_managed_trampoline_25 (id self, SEL _cmd, MonoMethod **managed_method_ptr, const char *r0, const char *r1)
{
	MonoObject *retval = NULL;
	guint32 exception_gchandle = 0;
	UIDatePicker * res = {0};
...
static void native_to_managed_trampoline_26 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UIDatePicker * p0, const char *r0, const char *r1, const char *r2)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
static void native_to_managed_trampoline_41 (id self, SEL _cmd, MonoMethod **managed_method_ptr, NSObject * p0, const char *r0, const char *r1, const char *r2)
{
	NSObject *nsobj0 = NULL;
	MonoObject *mobj0 = NULL;
	int32_t created0 = false;
...
@implementation QuestionnaireChoixRestoViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_22 (self, _cmd, &managed_method, "_50ShadesOfBurgers.QuestionnaireChoixRestoViewController, 50ShadesOfBurgers", "get_txtBurger");
	}

	-(void) setTxtBurger:(UITextField *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_23 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS", "_50ShadesOfBurgers.QuestionnaireChoixRestoViewController, 50ShadesOfBurgers", "set_txtBurger");
	}

	-(UITextField *) txtBurgerNew
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_22 (self, _cmd, &managed_method, "_50ShadesOfBurgers.QuestionnaireChoixRestoViewController, 50ShadesOfBurgers", "get_txtBurgerNew");
	}

	-(void) setTxtBurgerNew:(UITextField *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_23 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS", "_50ShadesOfBurgers.QuestionnaireChoixRestoViewController, 50ShadesOfBurgers", "set_txtBurgerNew");
	}

	-(UITextField *) txtName
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_22 (self, _cmd, &managed_method, "_50ShadesOfBurgers.QuestionnaireChoixRestoViewController, 50ShadesOfBurgers", "get_txtName");
	}

	-(void) setTxtName:(UITextField *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_23 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS", "_50ShadesOfBurgers.QuestionnaireChoixRestoViewController, 50ShadesOfBurgers", "set_txtName");
	}
...
@implementation Top10ViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_24 (self, _cmd, &managed_method, p0, p1, "UIKit.UIStoryboardSegue, Xamarin.iOS", "Foundation.NSObject, Xamarin.iOS", "_50ShadesOfBurgers.Top10ViewController, 50ShadesOfBurgers", "PrepareForSegue");
	}
...
@implementation FirstLoginViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_25 (self, _cmd, &managed_method, "_50ShadesOfBurgers.FirstLoginViewController, 50ShadesOfBurgers", "get_datePicker");
	}

	-(void) setDatePicker:(UIDatePicker *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_26 (self, _cmd, &managed_method, p0, "UIKit.UIDatePicker, Xamarin.iOS", "_50ShadesOfBurgers.FirstLoginViewController, 50ShadesOfBurgers", "set_datePicker");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_22 (self, _cmd, &managed_method, "_50ShadesOfBurgers.FirstLoginViewController, 50ShadesOfBurgers", "get_txtEmail");
	}

	-(void) setTxtEmail:(UITextField *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_23 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS", "_50ShadesOfBurgers.FirstLoginViewController, 50ShadesOfBurgers", "set_txtEmail");
	}
...
@implementation Top10TableViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_24 (self, _cmd, &managed_method, p0, p1, "UIKit.UIStoryboardSegue, Xamarin.iOS", "Foundation.NSObject, Xamarin.iOS", "_50ShadesOfBurgers.Top10TableViewController, 50ShadesOfBurgers", "PrepareForSegue");
	}
...
@implementation UIKit_UIBarButtonItem_Callback { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_41 (self, _cmd, &managed_method, p0, "Foundation.NSObject, Xamarin.iOS", "UIKit.UIBarButtonItem+Callback, Xamarin.iOS", "Call");
	}
...
@implementation UIKit_UITextField__UITextFieldDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_23 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS", "UIKit.UITextField+_UITextFieldDelegate, Xamarin.iOS", "EditingEnded");
	}

	-(void) textFieldDidBeginEditing:(UITextField *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_23 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS", "UIKit.UITextField+_UITextFieldDelegate, Xamarin.iOS", "EditingStarted");
	}
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [22].handle = objc_getClass ("CKShareMetadata");
	...
	__xamarin_class_map [36].handle = objc_getClass ("UIPickerView");
	...
	__xamarin_class_map [45].handle = objc_getClass ("NSTextAttachment");
	__xamarin_class_map [46].handle = objc_getClass ("NSTextContainer");
	__xamarin_class_map [47].handle = objc_getClass ("UIActivityIndicatorView");
	__xamarin_class_map [48].handle = objc_getClass ("MKMapView");
	__xamarin_class_map [49].handle = objc_getClass ("UIApplicationShortcutItem");
	__xamarin_class_map [50].handle = objc_getClass ("NSEnumerator");
	__xamarin_class_map [51].handle = objc_getClass ("NSException");
	__xamarin_class_map [52].handle = objc_getClass ("NSNotification");
	__xamarin_class_map [53].handle = objc_getClass ("NSNull");
	__xamarin_class_map [54].handle = objc_getClass ("UIDatePicker");
	...
	__xamarin_class_map [62].handle = objc_getClass ("UITabBarItem");
	__xamarin_class_map [63].handle = objc_getClass ("UIStoryboard");
	__xamarin_class_map [64].handle = objc_getClass ("UITableViewFocusUpdateContext");
	__xamarin_class_map [65].handle = objc_getClass ("UITableViewRowAction");
	__xamarin_class_map [66].handle = objc_getClass ("UIUserNotificationSettings");
	...
	__xamarin_class_map [74].handle = objc_getClass ("NSMutableDictionary");
	__xamarin_class_map [75].handle = objc_getClass ("NSNotificationCenter");
	__xamarin_class_map [76].handle = objc_getClass ("NSSet");
	__xamarin_class_map [77].handle = objc_getClass ("UIBarButtonItem");
	__xamarin_class_map [78].handle = objc_getClass ("UIGestureRecognizer");
	__xamarin_class_map [79].handle = objc_getClass ("UITextField");
	__xamarin_class_map [80].handle = objc_getClass ("UITextView");
	...
	__xamarin_class_map [91].handle = [QuestionnaireChoixRestoViewController class];
	...
	__xamarin_class_map [100].handle = [QuestionSixSevenEightViewController class];
	__xamarin_class_map [101].handle = [RestoDetailViewController class];
	__xamarin_class_map [102].handle = [Top10TableViewController class];
	__xamarin_class_map [103].handle = [_50ShadesOfBurgers_AutoCompleteTextFieldManager_AutoCompleteTableViewSource class];
	__xamarin_class_map [104].handle = objc_getClass ("UIKit_UIBarButtonItem_Callback");
