...
void xamarin_create_classes () {
	...
	__xamarin_class_map [7].handle = objc_getClass ("NSAttributedString");
	...
	__xamarin_class_map [12].handle = objc_getClass ("Foundation_InternalNSNotificationHandler");
	...
	__xamarin_class_map [22].handle = objc_getClass ("UIBarItem");
	__xamarin_class_map [23].handle = objc_getClass ("UIBezierPath");
	...
	__xamarin_class_map [32].handle = objc_getClass ("UIAlertView");
	__xamarin_class_map [33].handle = objc_getClass ("UITraitCollection");
	__xamarin_class_map [34].handle = objc_getClass ("UIToolbar");
	__xamarin_class_map [35].handle = objc_getClass ("UIScreen");
	__xamarin_class_map [36].handle = objc_getClass ("UIApplication");
	...
	__xamarin_class_map [50].handle = objc_getClass ("NSNotification");
	...
	__xamarin_class_map [62].handle = objc_getClass ("UIStoryboard");
	__xamarin_class_map [63].handle = objc_getClass ("UITableViewFocusUpdateContext");
	__xamarin_class_map [64].handle = objc_getClass ("UITableViewRowAction");
	__xamarin_class_map [65].handle = objc_getClass ("UITabBarItem");
	...
	__xamarin_class_map [74].handle = objc_getClass ("NSNotificationCenter");
