...
void xamarin_create_classes () {
	...
	__xamarin_class_map [97].handle = [FirstLoginViewController class];
	__xamarin_class_map [98].handle = [AppDelegate class];
	__xamarin_class_map [99].handle = [QuestionnaireChoixRestoViewController class];
